...
import com.padahehegame.truthordare.adapter.SimplestAdapter.ViewHolder;
import com.padahehegame.truthordare.base.BaseActivity;
import com.padahehegame.truthordare.database.DBTruthDareAdapter;
import com.padahehegame.truthordare.database.IDatabaseEntry;
...
import com.padahehegame.truthordare.view.BounceImageButton;
import com.padahehegame.truthordare.view.SpinningDrawableView;
import com.padahehegame.truthordare.view.SpinningDrawableView.OnStartRotatingListener;
import com.padahehegame.truthordare.view.SpinningDrawableView.OnStopRotatingListener;
...
public class ActivityGamePlay extends BaseActivity implements OnInitListener {
    ...
    public void openDialog() {
        try {
            this.adCnt++;
            this.playerName.setText(getElipsedStr(Utils.getCurrentPlayer(getApplicationContext()).playerName) + ", Giliranmu..!");
    ...
    private Dialog getCommonDialog(int resID) {
        ...
        dialog.getWindow().setBackgroundDrawableResource(R.drawable.bgrnd);
    ...
    private void openQuestionPopup(QuestionType type) {
        ...
        this.playerNameDialog2.setText(getElipsedStr(Utils.getCurrentPlayer(getApplicationContext()).playerName) + ", Ini Untukmu..");
